...
export default function ServicesPage() {
  return (
    <>
      ...
      {/* APPROACH INTRO — explains how Archangels approaches home care before diving into the list */}
      <section className="section-tight reveal">
        <div className="wrap prose-center">
          <span className="eyebrow" style={{ justifyContent: "center" }}>Our Approach to Home Care</span>
          <h2 style={{ marginTop: 14 }}>Care that starts with your family, not a service menu.</h2>
          <p>
            Every family that calls Archangels Personal Care is dealing with a different situation — a
            parent who&apos;s had a few too many close calls on the stairs, a spouse managing a new
            diagnosis, a sibling trying to hold down a job while checking in on Mom every day. We don&apos;t
            start with a fixed package and try to make your situation fit it. We start with a
            conversation, a free in-home assessment from a registered nurse, and a plan built around
            what your loved one actually needs, delivered by caregivers who take the time to get to
            know them.
          </p>
          <p>
            Below is every service we offer, each with its own dedicated page covering who it&apos;s for,
            what&apos;s included, what a visit might look like, and the questions families ask most. If
            you&apos;re not sure which service fits, that&apos;s exactly what a free consultation is for —
            call 804-903-8133 or request care online and we&apos;ll help you figure it out together.
          </p>
        </div>
      </section>
