  ...
  return (
    <ServiceDetailLayout
      ...
      approach={[
        ...
        "Every family experiences this time differently, so care plans are shaped around what would genuinely help — more hours some days, a quiet presence on others, always led by what the client and family need rather than a fixed schedule.",
      ]}
      faqs={[
        {
        ...
        {
          q: "How is this different from hospice care itself?",
          a: "Hospice provides the medical and clinical side of end-of-life care through a licensed hospice agency. We provide non-medical comfort and companionship that fills the time between hospice visits — the two work together, not in place of one another.",
        },
        {
          q: "Can family request specific caregiver qualities, like a calm temperament?",
          a: "Yes — we take time to understand what kind of presence would feel most comforting to your loved one and match a caregiver accordingly.",
        },
      ]}
      related={[
