...
export default function CompanionshipPage() {
  return (
    <ServiceDetailLayout
      ...
      scenario={{
        title: "A Weekly Visit Built Around Connection",
        text: "Every Tuesday afternoon, the same companion arrives with a deck of cards and genuine interest in hearing about the week. They might work on a jigsaw puzzle together, take a short walk if the weather is nice, or simply sit on the porch and talk. The companion helps set up a video call with a grandchild who lives out of state, jots down a grocery list for next time, and makes sure the visit ends with something to look forward to before the next one.",
      }}
      steps={[
      ...
      approach={[
        ...
        "Companionship isn't a lesser form of care — it's often the piece that makes every other service work better, since a caregiver who's built real rapport is also the one most likely to notice small changes in mood, appetite, or safety worth passing along to the family.",
      ]}
      faqs={[
        {
